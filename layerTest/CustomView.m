...
void drawLine (CGContextRef context)
{
    ...
    /**
     *  设置线条结束和开始点的形状 kCGLineCapButt 无修改   kCGLineCapRound 圆角  kCGLineCapSquare 起点是三角形 终点是正常
     */
    CGContextSetLineCap(context, kCGLineCapSquare);
    //设置起点
    CGContextMoveToPoint(context, 10, 10);
    //设置终点  (可连续设置终点 组成其他几何图形)
    CGContextAddLineToPoint(context, 60, 60);
    //设置颜色
    //    CGContextSetRGBStrokeColor(context, 1, 0, 0, 1);
    //设置颜色 描边颜色 stroke 描边  fill 填充
...
//    float leng={10,5};
//    CGContextSetLineDash(context, 0, leng, <#size_t count#>)
    CGContextMoveToPoint(context, 10, 10);
...
void drawCircle(CGContextRef context)
{
    ...
    CGContextStrokeEllipseInRect(context, CGRectMake(20, 20, 100, 100));
